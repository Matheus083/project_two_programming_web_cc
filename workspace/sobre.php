...
<body>
  ...
  <main class="sobre-page">
    ...
    <section class="sobre-box">
      ...
      <p>
        Nossa proposta é oferecer uma interface intuitiva, leve e agradável para que você organize suas músicas favoritas
        do jeito que preferir.
      </p>

      <p class="ano">
        Projeto criado para a disciplina de <strong>Desenvolvimento Web</strong>.
      </p>
    </section>
